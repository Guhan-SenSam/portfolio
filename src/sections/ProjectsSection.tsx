...
const TABS = [
  ...
  },
  {
    ...
    value: 'frontend',
    content: (
      <ProjectTabEntry title={'Frontend Projects'} content={filterProjectsByTag('Frontend')} />
    )
  },
  {
    title: 'Desktop',
    value: 'desktop',
    content: (
      <ProjectTabEntry title={'Desktop Applications'} content={filterProjectsByTag('Desktop')} />
    )
  },
  {
    title: 'Libraries',
      ...
      <section
        ...
        <div className=" flex flex-col text-center mt-20 items-center justify-center">
          <SubTitle
            ...
            duration={3000}
            className="sm:text-5xl text-3xl font-bold text-primary mb-2"
          />
          <motion.div
        ...
        <SlidePanel isOpen={isOpen} onClose={closeProject}>
          <ProjectSidecard onClose={closeProject} {...currentProject!}></ProjectSidecard>
        </SlidePanel>
      </section>
    </ProjectContext.Provider>
  );
